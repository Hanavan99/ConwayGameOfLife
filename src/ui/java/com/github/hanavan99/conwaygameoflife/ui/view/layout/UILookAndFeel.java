...
/**
 * The look and feel of the layout for the game
 * 
 * @author Zach Deibert
 */
public final class UILookAndFeel extends LookAndFeel {
	private static final String[] defaultTemplates = new String[] { UIManager.getSystemLookAndFeelClassName(), "Nimbus",
	...
	/**
	 * Initializes the {@link UILookAndFeel} and sets it as the default for AWT
	 */
